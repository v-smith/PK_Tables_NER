"""
Partial Split after continuous alpha or numeric characters, and split on special characters
"""
import re
import spacy
...
@spacy.registry.tokenizers("pk_table_tokenizer")
def create_pk_table_tokenizer():
    def create_tokenizer(nlp):
        prefix_re, infix_re, suffix_re = get_compiled_rex_rules()
        return Tokenizer(nlp.vocab, rules={},
                         prefix_search=prefix_re.search,
